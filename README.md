...
If you're new here, [notes on constraint system design](./constraint_system_design.pdf) is a good starting point. In fact the represent the beginning of an extensive revision of this repo. In the meantime, other docs may still be useful.
